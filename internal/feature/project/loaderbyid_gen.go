...
type LoaderByID struct {
	...
	cache map[LoaderByIDKey]*Project
...
func (l *LoaderByID) Load(key LoaderByIDKey) (*Project, error) {
...
func (l *LoaderByID) LoadThunk(key LoaderByIDKey) func() (*Project, error) {
	l.mu.Lock()
...
func (l *LoaderByID) LoadAll(keys []LoaderByIDKey) ([]*Project, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *LoaderByID) LoadAllThunk(keys []LoaderByIDKey) func() ([]*Project, []error) {
	results := make([]func() (*Project, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *LoaderByID) Prime(key LoaderByIDKey, value *Project) bool {
	l.mu.Lock()
	var found bool
...
func (l *LoaderByID) unsafeSet(key LoaderByIDKey, value *Project) {
	if l.cache == nil {
		l.cache = map[LoaderByIDKey]*Project{}
	}
	l.cache[key] = value
}
