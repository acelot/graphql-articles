...
type LoaderByID struct {
	...
	cache map[LoaderByIDKey]*Article
...
func (l *LoaderByID) Load(key LoaderByIDKey) (*Article, error) {
...
func (l *LoaderByID) LoadThunk(key LoaderByIDKey) func() (*Article, error) {
	l.mu.Lock()
...
func (l *LoaderByID) LoadAll(keys []LoaderByIDKey) ([]*Article, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *LoaderByID) LoadAllThunk(keys []LoaderByIDKey) func() ([]*Article, []error) {
	results := make([]func() (*Article, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *LoaderByID) Prime(key LoaderByIDKey, value *Article) bool {
	l.mu.Lock()
	var found bool
...
func (l *LoaderByID) unsafeSet(key LoaderByIDKey, value *Article) {
	if l.cache == nil {
		l.cache = map[LoaderByIDKey]*Article{}
	}
	l.cache[key] = value
}
