...
func (r *Repository) Find(ctx context.Context, conditions ...condition.Condition) ([]Image, error) {
	var items []Image
...
func (r *Repository) FindOneByID(ctx context.Context, id uuid.UUID) (*Image, error) {
...
func (r *Repository) Count(ctx context.Context, estimateThreshold int, conditions ...condition.Condition) (int, error) {
	query := r.secondaryDB.ModelContext(ctx, (*Image)(nil))
...
func (r *Repository) Insert(ctx context.Context, entity Image) error {
	_, err := r.primaryDB.ModelContext(ctx, &entity).Insert()

	return err
}

func (r *Repository) Update(ctx context.Context, entity Image) error {
