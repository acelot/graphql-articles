...
func (l *LoaderByID) Load(key LoaderByIDKey) (*Tag, error) {
...
func (l *LoaderByID) LoadThunk(key LoaderByIDKey) func() (*Tag, error) {
	l.mu.Lock()
...
func (l *LoaderByID) LoadAll(keys []LoaderByIDKey) ([]*Tag, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *LoaderByID) LoadAllThunk(keys []LoaderByIDKey) func() ([]*Tag, []error) {
	results := make([]func() (*Tag, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *LoaderByID) Prime(key LoaderByIDKey, value *Tag) bool {
	l.mu.Lock()
	var found bool
...
func (l *LoaderByID) unsafeSet(key LoaderByIDKey, value *Tag) {
	if l.cache == nil {
		l.cache = map[LoaderByIDKey]*Tag{}
	}
	l.cache[key] = value
}
